      ...
      <div className="mt-5">
        ...
        >
          ...
          <p className="mt-3 text-xs text-muted">
            Сейчас журнал фиксирует операции с данными (снимки, откат, бэкап). Подробный журнал
            каждого изменения по полям и серверная база — следующий этап (вместе с переносом на сервер).
          </p>
        </Card>
      </div>
    </div>
