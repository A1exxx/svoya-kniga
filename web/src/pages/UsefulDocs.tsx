...
import { useArchive, makeArchiveSnapshot } from '../state/archiveStore'
...
export function UsefulDocs() {
  ...
  const markDone = (it: NItem) =>
    addArchive({
      ...
      // Для записи-уведомления нужен только org (заголовок) — ops/docs/employees не читаются.
      snapshot: makeArchiveSnapshot(activeOrg),
    })
